...
namespace Dreamteck.Splines
{
    ...
    public class ObjectController : SplineUser
    {
        ...
        protected override void Build()
        {
            ...
            bool randomRotOffset = _minRotation != _maxRotation;
            ...
            for (int i = 0; i < spawned.Length; i++)
            {
                ...
                Vector3 right = Vector3.Cross(evalResult.direction, evalResult.normal).normalized;
                ...
                else spawned[i].position += right * posOffset.x * evalResult.size + evalResult.normal * posOffset.y * evalResult.size;
                ...
                if (_applyRotation)
                {
                    ...
                    if(_rotateByOffset) spawned[i].rotation = Quaternion.LookRotation(evalResult.direction, spawned[i].position - evalResult.position) * offsetRot;
