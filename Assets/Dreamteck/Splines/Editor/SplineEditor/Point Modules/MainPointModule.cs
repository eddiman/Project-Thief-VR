namespace Dreamteck.Splines.Editor
{
    ...
    public class MainPointModule : PointModule
    {
        ...
        public override void DrawInspector()
        {
            ...
            int option = 0;
            if (selectedPoints.Count == 1) { lastSelection = singleSelection = selectedPoints[0]; option = selectedPoints[0] + 4; }
            else if (selectedPoints.Count > 1) lastSelection = singleSelection = -1;
